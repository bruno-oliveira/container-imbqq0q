...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-imbqq0q.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-imbqq0q.containers.anotherwebservice.com/
...
```
git clone git@github.com:bruno-oliveira/container-imbqq0q.git
cd container-imbqq0q
```
...
```
docker attach container-imbqq0q
```
